    ...
    <section className="py-24 px-6 md:px-8 bg-white relative overflow-hidden">
      <div className="max-w-[1000px] mx-auto">
        <div className="text-center mb-20">
          <TechLabel className="mb-6">Our History</TechLabel>
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Legacy of Excellence</h2>
        </div>
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {milestones.map((milestone, i) => (
              ...
              >
                {/* Dot */}
                <div className="absolute left-[29px] md:left-1/2 top-0 w-2.5 h-2.5 bg-black rounded-full border-2 border-white ring-1 ring-gray-200 transform md:-translate-x-1/2 z-10 mt-2" />
                ...
                <div className={`flex-1 pl-20 md:pl-0 ${i % 2 === 0 ? "md:pr-16 md:text-right" : "md:pl-16 md:text-left"}`}>
                  ...
                  <span className="text-4xl font-bold text-gray-200 mb-2 block md:hidden">
                    {milestone.year}
                  </span>
                  <div className="relative z-10">
                    <div className="text-xl font-bold mb-2">{milestone.title}</div>

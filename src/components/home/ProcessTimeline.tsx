    ...
    <section ref={containerRef} className="relative bg-white">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8">
        <div className="flex flex-col lg:flex-row">
          {/* Sticky Left Side */}
          <div className="lg:w-1/2 lg:h-screen lg:sticky lg:top-0 flex flex-col justify-center py-12 sm:py-20 lg:py-0">
            <div className="max-w-xl">
              ...
              <h2 className="text-3xl sm:text-5xl md:text-7xl font-bold tracking-[-0.02em] mb-6 sm:mb-8 leading-[0.95]">
                Supply Chain
                <br />
          ...
          <div className="lg:w-1/2 py-8 sm:py-20 lg:py-32 space-y-8 sm:space-y-16 lg:space-y-32">
            {steps.map((step, i) => (
              <motion.div
                key={i}
                ...
                className="group relative bg-gray-50 border border-gray-100 p-6 sm:p-10 md:p-12 rounded-sm hover:shadow-2xl transition-all duration-500"
              >
                <div className="absolute -left-3 sm:-left-4 top-6 sm:top-10 w-6 h-6 sm:w-8 sm:h-8 bg-black text-white flex items-center justify-center text-[10px] sm:text-xs font-bold rounded-full border-2 sm:border-4 border-white">
                  {step.num}
                </div>

                <div className="mb-6 sm:mb-8">
                  <step.icon className="w-10 h-10 sm:w-12 sm:h-12 text-black mb-4 sm:mb-6" />
                  <h3 className="text-xl sm:text-3xl font-bold mb-3 sm:mb-4 tracking-tight">{step.title}</h3>
